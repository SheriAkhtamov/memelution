      ...
      <div className="flex flex-wrap items-center gap-1.5">
        {reactions.filter((r) => r.count > 0).map((r) => (
          <button
            ...
            data-active={r.reacted}
            className={`motion-pop motion-control flex items-center gap-1 rounded-full border px-2 py-0.5 text-xs font-black ${
              r.reacted
        ...
        <button
          ...
          className="motion-control flex h-11 w-11 items-center justify-center rounded-full border border-dashed border-gray-300 text-xs text-gray-400 hover:border-[#FF6B00] hover:text-[#FF6B00] dark:border-zinc-600 dark:hover:border-[#FF6B00]"
        >
          +
        </button>
      </div>
